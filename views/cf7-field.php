...
<div class="control-box">
    ...
    <fieldset>
        <legend id="<?php echo esc_attr( $tgg->ref( 'buttonlabel-option-legend' ) ); ?>"><?php
    ...
    <fieldset>
        <legend id="<?php echo esc_attr( $tgg->ref( 'multifiles-option-legend' ) ); ?>"><?php
    ...
    <fieldset>
        <legend id="<?php echo esc_attr( $tgg->ref( 'maxfiles-option-legend' ) ); ?>"><?php
